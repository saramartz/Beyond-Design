...
class PhotographyUsers extends Component {
            ...
            <>
                <Container>
                    <Row>                                      
                        ...
                        {
                            this.state.users.filter(elm => elm.specialty == "Photography").map(elm => <UserCard key={elm._id} {...elm}/>)                                                             
                        }
...
export default PhotographyUsers