...
class ModelingUsers extends Component {
            ...
            <>
                <Container>
                    <Row>                                      
                        ...
                        {
                            this.state.users.filter(elm => elm.specialty.toString() === "Modeling").map(elm => <UserCard key={elm._id} {...elm}/>)                                                             
                        }
