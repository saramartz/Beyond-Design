...
class MakeupUsers extends Component {
            ...
            <>
                <Container>
                    <Row>                                      
                        ...
                        {
                            this.state.users.filter(elm => elm.specialty.toString() === "Makeup Artist").map(elm => <UserCard key={elm._id} {...elm}/>)                                                             
                        }
