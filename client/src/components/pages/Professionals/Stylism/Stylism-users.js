...
class StylismUsers extends Component {
            ...
            <>
                <Container>
                    <Row>                                      
                        ...
                        {
                            this.state.users.filter(elm => elm.specialty.toString() === "Stylist").map(elm => <UserCard key={elm._id} {...elm}/>)                                                             
                        }
