...
class WorkDetails extends Component {
    ...
    displayBoard = () => {        
        const board_id = this.state.theBoard

        this.boardsService
            .getBoard(board_id)
            .then(res => this.setState({theBoard: {...res.data, images: res.data.images}}))
            .catch(err => console.log(err)) 
    }
       ...
       { this.state.theBoard.images && this.state.coworkers ?
            ...
            : null  }
                ...
                <Popup show={this.state.showModal} handleModal={this.handleModal} >
                    <WorkEdit closeModal={() => this.handleModal(false)} updateWork={this.displayWork} updateBoard={this.displayBoard} updateCoworkers={this.displayCoworkers} loggedUser={this.props.loggedUser} {...this.props}/>
                </Popup>
